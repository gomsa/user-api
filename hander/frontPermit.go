...
func (srv *FrontPermit) UpdateOrCreate(ctx context.Context, req *pb.Request, res *pb.Response) (err error) {
	// 前端权限写入数据库
	err = client.Call(ctx, srv.ServiceName, "FrontPermit.UpdateOrCreate", req, res)
	if err != nil {
		return err
	}
